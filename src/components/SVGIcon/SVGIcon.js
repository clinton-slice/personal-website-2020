    ...
    case "facebook":
      return (
        <path
          ...
          fill="#000"
          fillRule="nonzero"
          d="M304 108.8c-107.806 0-195.2 87.394-195.2 195.2s87.394 195.2 195.2 195.2 195.2-87.394 195.2-195.2-87.394-195.2-195.2-195.2zM350.238 243.69h-29.341c-3.477 0-7.339 4.575-7.339 10.656v21.186h36.703l-5.551 30.214h-31.152v90.707h-34.629v-90.707h-31.415v-30.214h31.415v-17.77c0-25.498 17.69-46.219 41.968-46.219h29.341v32.147z"
        />
      );
    case "codepen":
      return (
        <path
          ...
          fill="#000"
          fillRule="nonzero"
          d="M401.653 347.875l-96.911 64.608v-57.697l53.677-35.84zM411.617 324.732l-31.018-20.733 31.018-20.733v41.463zM279.992 412.482l-96.911-64.608 43.231-28.928 53.677 35.84v57.697zM292.367 333.249l-43.715-29.25 43.715-29.25 43.715 29.25zM358.421 289.054l-53.677-35.84v-57.697l96.911 64.608zM204.134 304l-31.018 20.733v-41.463zM226.314 289.054l-43.231-28.928 96.911-64.608v57.697zM148.367 260.125v87.749c0 4.018 2.089 8.035 5.464 10.287l131.624 87.749c2.089 1.286 4.5 2.089 6.911 2.089s4.822-0.804 6.911-2.089l131.624-87.749c3.375-2.25 5.464-6.268 5.464-10.287v-87.749c0-4.018-2.089-8.035-5.464-10.287l-131.624-87.749c-2.089-1.286-4.5-2.089-6.911-2.089s-4.822 0.804-6.911 2.089l-131.624 87.749c-3.375 2.251-5.464 6.268-5.464 10.287z"
        />
      );
    default:
      return <path />;
...
const SVGIcon = ({ name = "", color, url, fill }) => (
  <div>
    <SocialIconLink
    ...
    >
      ...
      >
        ...
        <g className="social-group" fill="none" fillRule="evenodd">
          ...
          />
          <circle
            className={`social-group__inner-circle social-group__inner-circle--${name}`}
            fill={fill}
            cx="300"
            cy="300"
            r="252.5"
